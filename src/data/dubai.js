const p = {
  ...
  details: {
    ...
    "co-authors": "Martyna Piech",
    date: "04-11-2021",
    investor: "Marshal's Office of the Lodzkie Region",
  },
  bigImgs: ["dubai/Floorplan.jpg"],
  imgs: [
    {
      title: "Entrance view",
  ...
  desc: [
    "The competition was organized by the Marshal's Office of the Lodz Region and the Lodz University of Technology to select the best exhibition design. <u>The conceptual design prepared by us won the first place, thus being transferred to the implementation stage. After the competition, in close cooperation with the Office, we specified the design for the executive tender.</u>",
    "The main inspiration for the project was golden autumn among the fields, referring to the time of the exhibition, distorted by the reversed direction of gravity. The centre of the composition was an immersive zone with a rectangular shape of four LED screens, on which shots from the Voivodeship were displayed.",
